...
clientSystem.initialize = function () {
	...
	clientSystem.registerEventData("functionxyzbt1:pinky", eventDataDefaults)
...
clientSystem.update = function() {
	...
	if (firstTick) {
		...
		let pinkyEventData = clientSystem.createEventData("functionxyzbt1:pinky");
		pinkyEventData.data.narf = true;

		clientSystem.broadcastEvent("functionxyzbt1:pinky", pinkyEventData);
	}
}
